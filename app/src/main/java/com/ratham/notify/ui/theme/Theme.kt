...
private val DarkColorPalette = NotifyColors(
    brand = primary,
    ...
    gradient2_1 = listOf(primary, secondary),
    gradient2_2 = listOf(Ocean4, Rose2),
    gradient2_3 = listOf(secondary, primary),
    tornado1 = listOf(Rose4, Ocean3),
    isDark = true
)


private val LightColorPalette = NotifyColors(
    brand = primary,
    brandSecondary = secondary,
...
fun ProvideNotifyColors(
    ...
    CompositionLocalProvider(LocalNotifyColors provides colorPalette, content = content)
}

object NotifyTheme {
    val colors: NotifyColors
        @Composable
        get() = LocalNotifyColors.current
}
...
private val LocalNotifyColors = staticCompositionLocalOf<NotifyColors> {
