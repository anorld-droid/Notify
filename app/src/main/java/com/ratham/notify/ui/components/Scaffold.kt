 ...
 * Wrap Material [androidx.compose.material.Scaffold] and set [NotifyTheme] colors.
 */
...
fun NotifyScaffold(
    ...
    drawerBackgroundColor: Color = NotifyTheme.colors.uiBackground,
    drawerContentColor: Color = NotifyTheme.colors.textSecondary,
    drawerScrimColor: Color = NotifyTheme.colors.uiBorder,
    backgroundColor: Color = NotifyTheme.colors.uiBackground,
